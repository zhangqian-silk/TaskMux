...
仓库维护说明：原样附件保存在 Git 提交 `bfdb32e7f705923886057f0907baedbadb8c7154`。
当前派生资料已按 T00/task-10 对齐 archived，并补充
[真实代码基线、验证与交接](implementation/designs/T00-current-baseline.md)；
当前清单不再代表原附件逐字内容。
